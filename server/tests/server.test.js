...
describe('GET /todos/:id', () => {
    ...
    it('should return a 404 if todo not found', (done) => {
        let wrongId = ObjectID().toHexString();
...
describe('PATCH /todos/:id', () => {
    it('should update the todo', (done) => {
        ...
        var text = "here is some new text";
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        ...
        var text = "here is some new text as well";
...
describe('GET /users/me', () => {
    ...
    it('should return 401 if token not authenticated', (done) => {
        request(app)
            .get('/users/me')
            .expect(401)
            .expect((res) => {
...
describe('POST /users', () => {
    ...
    it('should not create user if email in use', (done) => {
        var duplicateEmail = 'asdfguy@example.com';

        request(app)
            .post('/users')
            .send({
                email: duplicateEmail,
                password: '2984238kljsdjs'
            })
            .expect(400)
            .end(done);
    });
